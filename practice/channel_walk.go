...
//ExampleWithCancel 官方的一个context例子，但是看他的channal的使用
//使用函数反馈一个channal，同样可以使用
...
//ExampleWithCancel This example demonstrates the use of a cancelable context to prevent a
